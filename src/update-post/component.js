...
const UpdateComponent = (post) => {
  ...
  const [state, setState] = useState(post.post.state || "");
  const [spamText, setSpamText] = useState(post.post.spamText || "");
  const [zip, setZip] = useState(post.post.zip || "");
  ...
  return (
    <>
      ...
      >
        <h2 className="wd-title fw-bolder m-3 pb-3">Edit Post</h2>
        <div className="mb-3">
